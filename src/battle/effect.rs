...
impl EffectDef {
    pub fn to_effect(&self, target: CombatantId) -> Effect {
        match self {
            ...
            EffectDef::DrawCards { amount } => Effect::DrawCards { amount: *amount },
            EffectDef::DiscardCards {} => Effect::DiscardCards { amount: *amount },
        }
    }
}
...
pub enum Effect {
    ...
    DrawCards { amount: i32 },
    DiscardCards { target_card_index: usize },
}